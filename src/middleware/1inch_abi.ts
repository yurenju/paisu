export const ONE_INCH_EXCHANGE_V2_ABI = [
  {
    anonymous: false,
  ...
  {
    inputs: [
      { internalType: "contract IOneInchCaller", name: "caller", type: "address" },
      {
        components: [
      ...
      {
        components: [
          { internalType: "uint256", name: "targetWithMandatory", type: "uint256" },
...
export const ONE_INCH_LP_FARM_ABI = [
  {
    inputs: [
      { internalType: "contract Mooniswap", name: "_mooniswap", type: "address" },
      { internalType: "contract IERC20", name: "_gift", type: "address" },
